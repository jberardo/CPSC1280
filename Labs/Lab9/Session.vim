...
set ruler
set runtimepath=~/.vim,~/.vim/bundle/nerdtree,~/.vim/bundle/syntastic,~/.vim/bundle/tagbar,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/after
set showcmd
set softtabstop=2
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 39 - ((0 * winheight(0) + 20) / 40)
...
setlocal spellfile=
setlocal spelllang=en
setlocal statusline=%#StatusLineNC#[Name]\ .vimrc
setlocal suffixesadd=
setlocal noswapfile
setlocal synmaxcol=3000
if &syntax != 'tagbar'
